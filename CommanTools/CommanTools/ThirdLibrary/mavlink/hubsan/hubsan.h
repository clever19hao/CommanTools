/** @file
 *	@brief MAVLink comm protocol generated from hubsan.xml
 *	@see http://mavlink.org
 */
#ifndef MAVLINK_HUBSAN_H
#define MAVLINK_HUBSAN_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_HUBSAN.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
...
{
	MAV_CMD_HUBSAN_CAMERA=2, /* Command used for hubsan camera control. |defined by MAV_HUBSAN_CAMERA_CONTROL enum| Empty| Empty| Empty| Empty| Empty| Empty|  */
...
/** @brief Hubsan camera control command. */
#ifndef HAVE_ENUM_MAV_HUBSAN_CAMERA_CONTROL
#define HAVE_ENUM_MAV_HUBSAN_CAMERA_CONTROL
typedef enum MAV_HUBSAN_CAMERA_CONTROL
{
	MAV_HUBSAN_CAMERA_ENTER_SNAP=0, /* Enter snap function. | */
	MAV_HUBSAN_CAMERA_SNAP=1, /* snap a picture. | */
	MAV_HUBSAN_CAMERA_ENTER_RECORD=2, /* Enter record function. | */
	MAV_HUBSAN_CAMERA_RECORD_BEGIN=3, /* record begin. | */
	MAV_HUBSAN_CAMERA_RECORD_STOP=4, /* record stop. | */
	MAV_HUBSAN_CAMERA_VIDEO_OPEN=5, /* video open. | */
	MAV_HUBSAN_CAMERA_VIDEO_STOP=6, /* video stop. | */
	MAV_HUBSAN_CAMERA_VIDEO_1080P=7, /* video switch to 1080p. | */
	MAV_HUBSAN_CAMERA_VIDEO_720P=8, /* video switch to 720p. | */
	MAV_HUBSAN_CAMERA_VIDEO_VGA=9, /* video switch to VGA. | */
	MAV_HUBSAN_CAMERA_CONTROL_ENUM_END=10, /*  | */
} MAV_HUBSAN_CAMERA_CONTROL;
#endif

/** @brief  */
#ifndef HAVE_ENUM_MAV_SD_STATUS
#define HAVE_ENUM_MAV_SD_STATUS
typedef enum MAV_SD_STATUS
{
	MAV_HUBSAN_SD_INSERTED=0, /* SD card is inserted. | */
	MAV_HUBSAN_SD_ABSENCE=1, /* SD card is absent. | */
	MAV_HUBSAN_SD_MOUNT_ERROR=2, /* SD card is absent. | */
	MAV_SD_STATUS_ENUM_END=3, /*  | */
    MAV_SD_SPEED_CHECKING,
    MAV_SD_SPEED_LOW,
    MAV_SD_SPEED_OK,
    MAV_SD_NO_SPACE,
    MAV_SD_ERROR,
...
/** @brief  */
#ifndef HAVE_ENUM_MAV_HUBSAN_QUAD_MODE
#define HAVE_ENUM_MAV_HUBSAN_QUAD_MODE
typedef enum MAV_HUBSAN_QUAD_MODE
{
	MAV_HUBSAN_NORMAL=0, /* normal mode. | */
	MAV_HUBSAN_FREE_HEAD=1, /* free head mode. | */
	MAV_HUBSAN_QUAD_MODE_ENUM_END=2, /*  | */
} MAV_HUBSAN_QUAD_MODE;
#endif

/** @brief  */
#ifndef HAVE_ENUM_MAV_HUBSAN_RECORDING_STATUS
#define HAVE_ENUM_MAV_HUBSAN_RECORDING_STATUS
typedef enum MAV_HUBSAN_RECORDING_STATUS
{
	MAV_HUBSAN_NOT_RECORDING=0, /* camera is not recording. | */
	MAV_HUBSAN_IS_RECORDING=1, /* camera is recording. | */
	MAV_HUBSAN_RECORDING_STATUS_ENUM_END=2, /*  | */
} MAV_HUBSAN_RECORDING_STATUS;
#endif
...
// MESSAGE DEFINITIONS
#include "./mavlink_msg_mission_del.h"
#include "./mavlink_msg_hubsan_ack.h"
#include "./mavlink_msg_hubsan_quad_mode.h"
#include "./mavlink_msg_hubsan_sd_request.h"
#include "./mavlink_msg_hubsan_sd_status.h"
#include "./mavlink_msg_hubsan_quad_status.h"
#include "./mavlink_msg_hubsan_set_wifi.h"

#ifdef __cplusplus
}
#endif // __cplusplus
#endif // MAVLINK_HUBSAN_H
