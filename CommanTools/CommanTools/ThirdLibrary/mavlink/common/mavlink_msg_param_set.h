...
#define MAVLINK_MSG_ID_PARAM_SET_LEN 53
#define MAVLINK_MSG_ID_23_LEN 53
...
#define MAVLINK_MSG_PARAM_SET_FIELD_PARAM_VALUE2_LEN 30
...
#define MAVLINK_MESSAGE_INFO_PARAM_SET { \
	...
	{  { "param_value", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_param_set_t, param_value) }, \
         ...
         { "param_value2", NULL, MAVLINK_TYPE_CHAR, 30, 22, offsetof(mavlink_param_set_t, param_value2) }, \
         { "param_type", NULL, MAVLINK_TYPE_UINT8_T, 0, 52, offsetof(mavlink_param_set_t, param_type) }, \
         } \
}
...
static inline uint16_t mavlink_msg_param_set_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint8_t target_system, uint8_t target_component, const char *param_id, float param_value, const char *param_value2, uint8_t param_type)
{
	...
	_mav_put_uint8_t(buf, 52, param_type);
	_mav_put_char_array(buf, 6, param_id, 16);
	_mav_put_char_array(buf, 22, param_value2, 30);
...
{
	return mavlink_msg_param_set_pack(system_id, component_id, msg, param_set->target_system, param_set->target_component, param_set->param_id, param_set->param_value, param_set->param_value2, param_set->param_type);
}
...
{
	return mavlink_msg_param_set_pack_chan(system_id, component_id, chan, msg, param_set->target_system, param_set->target_component, param_set->param_id, param_set->param_value, param_set->param_value2, param_set->param_type);
}
...
static inline void mavlink_msg_param_set_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, const char *param_id, float param_value, const char *param_value2, uint8_t param_type)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_PARAM_SET_LEN];
	_mav_put_float(buf, 0, param_value);
 ...
 */
static inline void mavlink_msg_param_set_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, const char *param_id, float param_value, const char *param_value2, uint8_t param_type)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field param_value2 from param_set message
 *
 * @return Onboard string type parameter value2,
 */
static inline uint16_t mavlink_msg_param_set_get_param_value2(const mavlink_message_t* msg, char *param_value2)
{
	return _MAV_RETURN_char_array(msg, param_value2, 30,  22);
}
...
static inline void mavlink_msg_param_set_decode(const mavlink_message_t* msg, mavlink_param_set_t* param_set)
{
	...
	mavlink_msg_param_set_get_param_value2(msg, param_set->param_value2);
