...
typedef struct __mavlink_param_value_t
{
 ...
 char param_value2[30]; ///< Onboard string type parameter value2,
 uint8_t param_type; ///< Onboard parameter type: see the MAV_PARAM_TYPE enum for supported data types.
} mavlink_param_value_t;

#define MAVLINK_MSG_ID_PARAM_VALUE_LEN 55
#define MAVLINK_MSG_ID_22_LEN 55

#define MAVLINK_MSG_ID_PARAM_VALUE_CRC 49
#define MAVLINK_MSG_ID_22_CRC 49

#define MAVLINK_MSG_PARAM_VALUE_FIELD_PARAM_ID_LEN 16
#define MAVLINK_MSG_PARAM_VALUE_FIELD_PARAM_VALUE2_LEN 30
...
#define MAVLINK_MESSAGE_INFO_PARAM_VALUE { \
	...
	{  { "param_value", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_param_value_t, param_value) }, \
         ...
         { "param_value2", NULL, MAVLINK_TYPE_CHAR, 30, 24, offsetof(mavlink_param_value_t, param_value2) }, \
         { "param_type", NULL, MAVLINK_TYPE_UINT8_T, 0, 54, offsetof(mavlink_param_value_t, param_type) }, \
         } \
}
 ...
 * @param param_value2 Onboard string type parameter value2,
...
static inline uint16_t mavlink_msg_param_value_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       const char *param_id, float param_value, const char *param_value2, uint8_t param_type, uint16_t param_count, uint16_t param_index)
{
	...
	_mav_put_uint8_t(buf, 54, param_type);
	_mav_put_char_array(buf, 8, param_id, 16);
	_mav_put_char_array(buf, 24, param_value2, 30);
	...
	mav_array_memcpy(packet.param_value2, param_value2, sizeof(char)*30);
...
{
	return mavlink_msg_param_value_pack(system_id, component_id, msg, param_value->param_id, param_value->param_value, param_value->param_value2, param_value->param_type, param_value->param_count, param_value->param_index);
}
...
{
	return mavlink_msg_param_value_pack_chan(system_id, component_id, chan, msg, param_value->param_id, param_value->param_value, param_value->param_value2, param_value->param_type, param_value->param_count, param_value->param_index);
}
...
static inline void mavlink_msg_param_value_send(mavlink_channel_t chan, const char *param_id, float param_value, const char *param_value2, uint8_t param_type, uint16_t param_count, uint16_t param_index)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_PARAM_VALUE_LEN];
	_mav_put_float(buf, 0, param_value);
 ...
 */
static inline void mavlink_msg_param_value_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  const char *param_id, float param_value, const char *param_value2, uint8_t param_type, uint16_t param_count, uint16_t param_index)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field param_value2 from param_value message
 *
 * @return Onboard string type parameter value2,
 */
static inline uint16_t mavlink_msg_param_value_get_param_value2(const mavlink_message_t* msg, char *param_value2)
{
	return _MAV_RETURN_char_array(msg, param_value2, 30,  24);
}
...
static inline void mavlink_msg_param_value_decode(const mavlink_message_t* msg, mavlink_param_value_t* param_value)
{
	...
	mavlink_msg_param_value_get_param_value2(msg, param_value->param_value2);
