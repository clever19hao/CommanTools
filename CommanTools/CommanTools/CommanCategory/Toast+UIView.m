...
- (void)makeToastActivity:(id)position {
    ...
    activityView.layer.cornerRadius = CSToastActivityWidth / 2;
...
//    label.frame = CGRectMake(20, 75, 70, 20);
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (title != nil) {
        ...
        CGRect boundingRect = [title boundingRectWithSize:maxSizeTitle options:NSStringDrawingUsesLineFragmentOrigin attributes:attributes context:nil];
        
        CGSize expectedSizeTitle = boundingRect.size;
    ...
    if (message != nil) {
        ...
        NSDictionary *attributes = @{NSFontAttributeName:messageLabel.font, NSParagraphStyleAttributeName:paragraphStyle};
        CGRect boundingRect = [message boundingRectWithSize:maxSizeMessage options:NSStringDrawingUsesLineFragmentOrigin attributes:attributes context:nil];
        
        CGSize expectedSizeMessage = boundingRect.size;
